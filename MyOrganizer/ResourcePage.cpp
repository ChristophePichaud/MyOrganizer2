...
IMPLEMENT_DYNCREATE(CResourcePage, BASE_PROP_PAGE)

CResourcePage::CResourcePage() : BASE_PROP_PAGE(CResourcePage::IDD)
{
...
BEGIN_MESSAGE_MAP(CResourcePage, BASE_PROP_PAGE)
