...
protected:
	...
	{
		CString strError;
		strError.Format(_T("Cannot open demo database file.\nError code: 0x%X\nError message: %s\n\nPlease check that \'organizer_tasks.mdb\' file is located in the same folder as this program and ADO drivers were properly installed."), err.Error(), err.ErrorMessage());
