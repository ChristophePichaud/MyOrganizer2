...
int CShortcutsBar::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
	...
	AddTask (nGroup2, _T("Windows Scenic"), -1, ID_VIEW_APPLOOK_5);
	...
	AddTask (nGroup2, _T("Office 2016 (colorful)"), -1, ID_VIEW_APPLOOK_12);
	AddTask (nGroup2, _T("Office 2016 (dark gray)"), -1, ID_VIEW_APPLOOK_13);
	AddTask (nGroup2, _T("Office 2016 (white)"), -1, ID_VIEW_APPLOOK_14);
	AddTask (nGroup2, _T("Office 2016 (black)"), -1, ID_VIEW_APPLOOK_15);
#endif
