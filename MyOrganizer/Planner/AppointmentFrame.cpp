...
BEGIN_MESSAGE_MAP(CAppointmentDialogBar1, CEditDialogBar)
	ON_UPDATE_COMMAND_UI(IDC_APP_EDIT_MEETING, OnUpdateDummy)
	ON_UPDATE_COMMAND_UI(IDC_APP_EDIT_PHONECALL, OnUpdateDummy)
END_MESSAGE_MAP()
...
BOOL CAppointmentDialogBar1::OnInitDialogBar()
{
	...
	if (pLayout != NULL)
	{
		pLayout->AddAnchor (IDC_APP_EDIT_SUBJECT, CBCGPStaticLayout::e_MoveTypeNone, CBCGPStaticLayout::e_SizeTypeHorz);
		pLayout->AddAnchor (IDC_APP_EDIT_LOCATION, CBCGPStaticLayout::e_MoveTypeNone, CBCGPStaticLayout::e_SizeTypeHorz);
		pLayout->AddAnchor (IDC_APP_EDIT_MEETING, CBCGPStaticLayout::e_MoveTypeHorz, CBCGPStaticLayout::e_SizeTypeNone);
		pLayout->AddAnchor (IDC_APP_EDIT_PHONECALL, CBCGPStaticLayout::e_MoveTypeHorz, CBCGPStaticLayout::e_SizeTypeNone);
	}
...
BEGIN_MESSAGE_MAP(CAppointmentDialogBar2, CEditDialogBar)
	ON_COMMAND(ID_APP_EDIT_ALLDAY, OnAllDay)
	ON_UPDATE_COMMAND_UI(ID_APP_EDIT_ALLDAY, OnUpdateDummy)
END_MESSAGE_MAP()
...
BOOL CAppointmentDialogBar2::OnInitDialogBar()
{
	...
	if (pLayout != NULL)
	{
		pLayout->AddAnchor (IDC_APP_EDIT_SEPARATOR, CBCGPStaticLayout::e_MoveTypeNone, CBCGPStaticLayout::e_SizeTypeHorz);
	}
...
void CAppointmentFrame::OnOK() 
{
	...
	if (!m_Appointment.IsRecurrence () || m_Appointment.IsRecurrenceClone ())
	{
		...
		if (dtS > dtF)
		{
			BCGPMessageBox(IDS_APPOINTMENT_1);
			return;
		}
