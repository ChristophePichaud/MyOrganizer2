...
BCGPKey stdKeys [] =
{
    ...
    {    ID_EDIT_DECREASE_INDENT, _T("ao")    },
    {    ID_EDIT_INCREASE_INDENT, _T("ai")    },
    ...
    {    ID_FONT_COLOR, _T("fc")    },
	{    ID_FONT_QUALITY, _T("fq")    },

	// 3. Grid:
	{    ID_GRID_VIEW_GROUPBOX, _T("g")    },
	{    ID_GRID_VIEW_FIELDCHOOSER, _T("c")    },
	{    ID_GRID_VIEW_COLUMN_AUTO_RESIZE, _T("ar")    },

#ifndef _BCGSUITE_INC_
	// 3. Application look:
    {    ID_VIEW_APPLOOK_1, _T("b")    },
    {    ID_VIEW_APPLOOK_2, _T("l")    },
    {    ID_VIEW_APPLOOK_3, _T("s")    },
    {    ID_VIEW_APPLOOK_4, _T("a")    },

    {    ID_VIEW_APPLOOK_5, _T("w")    },

    {    ID_VIEW_APPLOOK_6, _T("1b")   },
    {    ID_VIEW_APPLOOK_7, _T("1s")   },
    {    ID_VIEW_APPLOOK_8, _T("1l")   },

    {    ID_VIEW_APPLOOK_9, _T("3w")   },
    {    ID_VIEW_APPLOOK_10, _T("3l")  },
    {    ID_VIEW_APPLOOK_11, _T("3d")  },

    {    ID_VIEW_APPLOOK_12, _T("6c")   },
    {    ID_VIEW_APPLOOK_13, _T("6d")  },
    {    ID_VIEW_APPLOOK_14, _T("6w")  },
    {    ID_VIEW_APPLOOK_15, _T("6b")  },
#endif
	{    0, NULL    },
};
...
BCGPKey mainKeys [] =
{
	...
	{    ID_PLANNER_MODE_SCHEDULE, _T("ms")    },
