// TaskAndCode.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CTaskAndCodeApp, CBCGPWinApp)
...
// CTaskAndCodeApp construction

CTaskAndCodeApp::CTaskAndCodeApp()
{
...
// The one and only CTaskAndCodeApp object

CTaskAndCodeApp theApp;


// CTaskAndCodeApp initialization

BOOL CTaskAndCodeApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_TaskAndCodeTYPE,
		RUNTIME_CLASS(CTaskAndCodeDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CTaskAndCodeView));
	if (!pDocTemplate)
		return FALSE;
...
// CTaskAndCodeApp message handlers

int CTaskAndCodeApp::ExitInstance() 
{
...
void CTaskAndCodeApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
void CTaskAndCodeApp::PreLoadState()
{
...
BOOL CTaskAndCodeApp::SaveAllModified()
{
